<?php
return array(
    'mailSubjectSuccess' => env('SECURITY_CHECK_SUBJECT_SUCCESS', '[composer-security-check]: Ok - no vulnerabilities detected.'),
    ...
    'mailViewName' => env('SECURITY_CHECK_MAIL_VIEW_NAME', 'security-check.mail'),
