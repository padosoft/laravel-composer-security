...
class ComposerSecurityCheckTest extends TestBase
{
    ...
    {
        Artisan::call('composer-security:check',['path'=>__DIR__,'--mail'=>'helpdesk@padosoft.com','--whitelist'=>'Y:\laravel-packages\www\laravel\5.1.x\packages\padosoft\laravel-composer-security\tests\,paperino']);
